...
export class activadoDeleteCascadePermiso1637904751294 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mod_auth"."rol_permiso" ADD CONSTRAINT "FK_3c476728351cd2f8f875ceb32ee" FOREIGN KEY ("permiso_id") REFERENCES "mod_auth"."permiso"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mod_auth"."user_permiso" ADD CONSTRAINT "FK_316431d4186ebd06d35b2e61f3d" FOREIGN KEY ("permiso_id") REFERENCES "mod_auth"."permiso"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
